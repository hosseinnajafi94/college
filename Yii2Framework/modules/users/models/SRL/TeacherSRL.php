...
use app\modules\users\models\VML\TeacherVML;
...
class TeacherSRL {
    ...
    public static function searchModel() {
        ...
        $query->andWhere(['group_id' => $module->params['group.Teacher']]);
    ...
    public static function insert($data, $userId, $postParams = []) {
        ...
        $model->group_id      = $module->params['group.Teacher'];
