...
use app\modules\users\models\VML\StudentVML;
...
class StudentSRL {
    ...
    public static function searchModel() {
        ...
        $query->andWhere(['group_id' => $module->params['group.Student']]);
    ...
    public static function insert($data, $userId, $postParams = []) {
        ...
        $model->group_id      = $module->params['group.Student'];
